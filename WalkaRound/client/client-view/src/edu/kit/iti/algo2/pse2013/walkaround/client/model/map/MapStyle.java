...
public class MapStyle {
	 ...
	 *  Mapnik Kartenstil.
	 */
	public static MapStyle MAPSTYLE_MAPNIK = new MapStyle(0,0,"Mapnik", "", 5);
	
	/**
	 *  Wanderkarten Kartenstil
	 */
	public static MapStyle MAPSTYLE_WANDERKARTE = new MapStyle(0,0,"Wanderkartek", "", 5);
	
	/**
	 *  Mapquest KArtenstil.
	 */
	public static MapStyle MAPSTYLE_MAPQUEST = new MapStyle(0,0,"MapQuest", "", 5);
