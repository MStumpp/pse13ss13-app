 ...
 *
 */
public class PullUpViewOld extends Fragment implements RouteListener {

	/**
	 * Debug Information
	 */
	private static final String TAG_PULLUP = PullUpViewOld.class.getSimpleName();
	private static final String TAG_PULLUP_ANIMATIOn = PullUpViewOld.class
			.getSimpleName() + "_animate";
	private static final String TAG_PULLUP_TOUCH = PullUpViewOld.class
	...
	private class RoutingListener implements OnTouchListener {
		...
		public boolean onTouch(View v, MotionEvent event) {
			if (v.equals(routing)
				...
				changeView(PullUpViewOld.CONTENT_ROUTING);
				setFullSizeHeight();
				return false;
			}
			return true;
	...
	private class RoundtripListener implements OnTouchListener {
		...
		public boolean onTouch(View v, MotionEvent event) {
			...
			if (v.equals(roundtrip)
				...
				changeView(PullUpViewOld.CONTENT_ROUNDTRIP);
				setFullSizeHeight();
				return false;
			}
			return true;
	...
	private class POIListener implements OnTouchListener {
		...
		public boolean onTouch(View v, MotionEvent event) {
			...
			if (v.equals(poi) && event.getAction() == MotionEvent.ACTION_DOWN) {
				...
				changeView(PullUpViewOld.CONTENT_POI);
				setHalfSizeHeight();
				return false;
			}
			return true;
	...
	private class SearchListener implements OnTouchListener {
		...
		public boolean onTouch(View v, MotionEvent event) {
			...
			if (v.equals(search)
				...
				changeView(PullUpViewOld.CONTENT_SEARCH);
				setFullSizeHeight();
				return false;
			}
			return true;
