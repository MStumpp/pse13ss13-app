...
public class MapViewOld extends Activity {
	 ...
	 * Debug Information
	 */
	private static final String TAG_MAPVIEW = MapViewOld.class.getSimpleName();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		MapControllerOld.getInstance().startController(this);
		mc = MapControllerOld.getInstance();
		...
		Fragment headUp = new HeadUpViewOld();
